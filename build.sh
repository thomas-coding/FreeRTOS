...
# objdump
#arm-none-eabi-objdump -Slg ${demo_dir}/build/RTOSDemo.axf  ${demo_dir}/build/RTOSDemo.asm
arm-none-eabi-objdump -xd ${demo_dir}/build/RTOSDemo.axf  > ${demo_dir}/build/RTOSDemo.asm
